<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="work.SchedProj.Sched.Forms.Login" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" 
            Text="Meeting Scheduler"></asp:Label>
    </div>
    <p class="style1">
        <asp:Image ID="Image2" runat="server" ImageURL="~/Forms/images/clip-art-meeting-466232.jpg"></asp:Image>
    </p>        
    <div>
